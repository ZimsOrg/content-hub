    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          ...
          "data-open:animate-in data-open:slide-in-from-bottom data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0 data-closed:duration-100",
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            render={
              <Button
                variant="outline"
                className="absolute top-[max(env(safe-area-inset-top,12px),12px)] right-3 z-20 size-10 rounded-full border-border/50 bg-background/80 backdrop-blur sm:top-3 sm:right-3 sm:size-9"
                size="icon"
              />
            }
          >
